package com.example.scheduler;
         ...
         public class DynamicTaskScheduler {
             ...
             private void executeTask(Task task) {
                 ...
                 task.setPredictedExecutionTime(predictedTime); // Set the predicted value
                 System.out.println("Executing task: " + task.getName() + " (Priority: " + task.getPriority() + ", Predicted Time: " + predictedTime + "ms)");
                 executorService.submit(() -> {
                     try {
                         Thread.sleep((long) predictedTime); // Use predicted time
